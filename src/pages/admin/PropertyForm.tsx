...
const PropertyForm = () => {
            ...
            const fetchProperty = async () => {
                ...
                if (error) {
                    ...
                    setFormData({
                        ...
                        card_images: data.card_images || (data.images ? data.images.slice(0, 3) : []),
                        gallery_images: data.gallery_images || (data.images ? data.images.slice(3, 7) : []),
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const propertyData = {
            ...
            card_images: formData.card_images,
